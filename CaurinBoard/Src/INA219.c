...
void sendMessageCAN(INA* ina, CAN_HandleTypeDef* phcan, uint8_t ina_id){
	...
	can_tx_pkg.data[6] = ina_id;

	//IDENTIFIER
	//b0 = i2c -> 0 = i2c1; 1 = i2c2;
	//b1 = ina -> 00 = ina1; 01 = ina2;
	//b2 = ina -> 10 = ina3; 11 = ina3;
	//b3 = data -> 000 = shuntvoltage; 001 = busvoltage;		<- modified by this function
	//b4 = data -> 010 = current_mA; 011 = power_mW;			<- modified by this function
	//b5 = data -> 100 = loadvoltage; others = unused;			<- modified by this function
	//b6 = unused
	//b7 = unused
