...
size_t LoRaClass::print(unsigned char b, int base)
{
...
size_t LoRaClass::print(unsigned int n, int base)
{
...
size_t LoRaClass::print(unsigned long n, int base)
{
  if (base == 0) return write(n);
  else return printNumber(n, base);
}

size_t LoRaClass::print(double n, int digits)
{
...
size_t LoRaClass::printFloat(double number, uint8_t digits)
{
  size_t n = 0;
